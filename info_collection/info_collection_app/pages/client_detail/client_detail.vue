...
<script>
	...
	export default {
        ...
        onLoad: function(option) {
            this.client_id = option.client_detail_id;
		...
		methods: {
            post_data(self) {
                ...
                if (this.item_list[1]!='' && !(this.item_list[1]>=0 && this.item_list[1]<=500)) {
                	verify_input = false
                    uni.showToast({
                        icon: 'none',
                        title: '客户信息更新失败！错误原因：员工数量必须在0至500之间！',
                        duration: 4000
                    });
                }
                    ...
                    uni.showToast({
                        icon: 'none',
                        title: '办公电话更新失败！错误原因：办公电话必须用11位数字表示，以029开始！',
                        duration: 4000
                    });
                }
                    ...
                    uni.showToast({
                        icon: 'none',
                        title: '手机号码更新失败！错误原因：手机号码必须用11位数字表示！',
                        duration: 4000
                    });
                }
                    ...
                    uni.showToast({
                        icon: 'none',
                        title: '营服客户经理联系方式更新失败！错误原因：营服客户经理联系方式必须用11位数字表示！',
                        duration: 4000
                    });
                }
                    ...
                    uni.showToast({
                        icon: 'none',
                        title: '客户ID更新失败！错误原因：客户ID必须用数字表示！',
                        duration: 4000
                    });
                }
                    ...
                    uni.showToast({
                        icon: 'none',
                        title: '代表号码更新失败！错误原因：代表号码必须用数字表示！',
                        duration: 4000
                    });
                }
                    ...
                    uni.showToast({
                        icon: 'none',
                        title: '付费编码更新失败！错误原因：付费编码必须用数字表示！',
                        duration: 4000
                    });
                }
                    ...
                    uni.showToast({
                        icon: 'none',
                        title: '宽带数量更新失败！错误原因：宽带数量必须在0至20之间！',
                        duration: 4000
                    });
                }
                    ...
                    uni.showToast({
                        icon: 'none',
                        title: '固话数量更新失败！错误原因：固话数量必须在0至200之间！',
                        duration: 4000
                    });
                }
                    ...
                    uni.showToast({
                        icon: 'none',
                        title: '天翼数量更新失败！错误原因：天翼数量必须在0至300之间！',
                        duration: 4000
                    });
                }
                    ...
                    uni.showToast({
                        icon: 'none',
                        title: '智慧企业数量更新失败！错误原因：智慧企业数量必须在0至20之间！',
                        duration: 4000
                    });
                }
                    ...
                    uni.showToast({
                        icon: 'none',
                        title: 'IP数量更新失败！错误原因：IP数量必须用数字表示！',
                        duration: 4000
                    });
                } else {
                    var post_data = {
                    ...
                    this.$api.request({
                        url: '/infocollect/updateclientdetail',
                        data: post_data,
                        method: 'POST',
        ...
        onShow() {
            ...
            this.$api.request({
                url: '/infocollect/clientdetail',
                method: 'POST',
                data:data
            }).then((data)=>{
                this.item_list = data.item_list
                var int_index = [1,13,14,15,16,17,19,21,23,27]
                for (let x in int_index) {
                	this.item_list[int_index[x]] = String(this.item_list[int_index[x]])
                }
                this.index = this.array.findIndex((value)=>value==this.item_list[2])
                this.index1 = this.array1.findIndex((value)=>value==this.item_list[9])
                this.index2 = this.array2.findIndex((value)=>value==this.item_list[22])
                this.index3 = this.array3.findIndex((value)=>value==this.item_list[24])
                this.index4 = this.array4.findIndex((value)=>value==this.item_list[26])
                this.index5 = this.array5.findIndex((value)=>value==this.item_list[28])
                this.index6 = this.array6.findIndex((value)=>value==this.item_list[29])
                this.index7 = this.array7.findIndex((value)=>value==this.item_list[34])
                this.index8 = this.array8.findIndex((value)=>value==this.item_list[39])
            });
        },
	}
</script>
